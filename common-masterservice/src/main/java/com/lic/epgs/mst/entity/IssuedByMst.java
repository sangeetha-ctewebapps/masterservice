...
@Entity
@Table(name = "MASTER_ISSUED_BY")
public class IssuedByMst implements Serializable {
	...
	public String getIssueByCode() {
		return issueByCode;
	}

	public void setIssueByCode(String issueByCode) {
		this.issueByCode = issueByCode;
	}
